...
s'appuie sur 420 tests unitaires automatisés. Ce document constitue une première
...
log) est couverte par \textbf{420 tests unitaires} automatisés (Node, sans webcam),
